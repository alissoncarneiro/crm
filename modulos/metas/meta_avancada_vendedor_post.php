...
<table border="0" align="center" cellspacing="2" cellpadding="2">
    <tr>
        <td colspan="10" align="left" valign="center" bgcolor="#000080">
            ...
            ?>
            <strong><font color="#FFFFFF">Controle de Metas e Resultados Individuais da Área Comercial Interna</font></strong></td>
    </tr>
    <tr>
        <td colspan="10" align="center" bgcolor="#FF8C00"><strong><font color="#FFFFFF">Período :<?php echo dten2br($dt_inicio) . ' até ' . dten2br($dt_fim); ?> / Vendedor : <?php echo $vend['nome_usuario']; ?></font></strong></td>
    </tr>
    <tr>
