...
echo "*============================================================*<br>";
echo "Carga de Tab. Preço Datasul ERP via ODBC<br>";
echo "*============================================================*<br>";
...
$tabela_erp = 'pub."tb-preco"';
$campo_chave_erp = 'nr-tabpre';
$campo_descr_erp = 'descricao';

$tabela_crm = 'is_tab_preco';
$campo_chave_crm = 'id_tab_preco_erp';
...
$ar_depara = array(
                    'id_tab_preco_erp' 	=> 'nr-tabpre',
                    'nome_tab_preco' 	=> 'descricao'
             );
...
$ar_fixos = array(
  ...
  $sql = 'select * from '.$tabela_erp.' where situacao = 1 and "dt-inival" <= '."'".date("Y-m-d")."' and ".'"dt-fimval" >= '."'".date("Y-m-d")."'";
