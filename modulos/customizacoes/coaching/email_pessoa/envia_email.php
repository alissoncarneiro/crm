...
function inseriHtml(ordem){	
    ...
    $.post('modulos/customizacoes/coaching/email_pessoa/retorno_peca.php',                          
           ({
				acao: ordem,
				id_pessoa:<?=$_REQUEST['numreg']?>
			}),                              												
           function(retorno){                                       								
                if (retorno !='') {																                            
...
function atualizaHtml(numregModelo){
    ...
    ?>
<div id="ret"> </div>
    <form action="modulos/venda/envio_email/executa_envio_email_custom.php" id="form_envio_email" name="form" method="post" enctype="multipart/form-data" onsubmit="return AIM.submit(this, {'onStart' : UploadstartCallback, 'onComplete' : UploadcompleteCallback});">
