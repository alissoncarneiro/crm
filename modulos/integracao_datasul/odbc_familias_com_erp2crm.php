...
$tabela_erp = 'pub."fam-comerc"';
$campo_chave_erp = 'fm-cod-com';
$campo_descr_erp = 'descricao';

$tabela_crm = 'is_familia_comercial';
$campo_chave_crm = 'id_familia_erp';
...
$ar_depara = array(
                    'id_familia_erp' 			=> 'fm-cod-com',
                    'nome_familia_comercial'           	=> 'descricao'
            );

$ar_fixos = array('sn_ativo'   => '1');
