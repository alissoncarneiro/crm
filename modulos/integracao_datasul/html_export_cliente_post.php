...
$qry_cliente_exp = query("SELECT t1.* FROM is_exp_cli t1 LEFT JOIN is_pessoas t2 ON t1.numreg_pessoa = t2.numreg WHERE (t1.exportado = 'N' OR t1.exportado IS NULL) AND t2.id_relac = '4' ORDER BY t1.numreg ASC");
...
echo "Foram exportado(s) ".$total." cliente(s).";
?>