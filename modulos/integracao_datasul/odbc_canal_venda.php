...
$tabela_erp = 'pub."canal-venda"';
$campo_chave_erp = 'cod-canal-venda';
$campo_descr_erp = 'descricao';

$tabela_crm = 'is_canal_venda';
$campo_chave_crm = 'id_canal_venda_erp';
...
$ar_depara = array(
								'id_canal_venda_erp' 			=> 'cod-canal-venda',
								'nome_canal_venda' 			=> 'descricao'
								);
