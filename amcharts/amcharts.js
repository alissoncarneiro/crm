...
AmCharts.AmChart = AmCharts.Class({
    construct: function () {
        ...
        this.allLabels = [];
        this.titles = [];
        this.marginRight = this.marginLeft = this.autoMarginOffset = 20;
    ...
    write: function (a) {
        ...
        if (e) switch (e.position) {
            ...
            case "right":
                ...
                break;
            case "left":
                h = document.createElement("div"), i = h.style, i.position = "relative", i.width = a.style.width, i.height = a.style.height, a.appendChild(h), f.position = "relative", g.position = "absolute", h.appendChild(b),
                h.appendChild(d)
    ...
    initChart: function () {
        ...
        if (document.attachEvent && !window.opera) {
            var a = 1,
                b = this.legend;
            if (b && (b = b.position, "right" == b || "left" == b)) "relative" != AmCharts.getStyle(this.div, "position") && (a = 2)
        }
...
AmCharts.Cuboid = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (0 < f || 0 < g) {
            ...
            p = AmCharts.polygon(b, [0, f, d + f, d, 0], [e, e + g, e + g, e, e], q, i, 0, 0, 0, m);
            if (0 < l) var C = AmCharts.line(b, [0, f, d + f], [e, e + g, e + g], k, l, j)
        }
        1 > Math.abs(e) && (e = 0);
        1 > Math.abs(d) && (d = 0);
        b = 0 == e ? AmCharts.line(b, [0, d], [0, 0], n, l, j) : 0 == d ? AmCharts.line(b, [0, 0], [0, e], n, l, j) : 0 < r ? AmCharts.rect(b, d, e, h, i, j, k, l, r, m) : AmCharts.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0], h, i, j, k, l, m);
        e = 0 > e ? [s, t, u, x, z, y, v, p, C, b] : [p, C, u, x, z, y, s, t, v, b];
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                var m = this.balloonColor,
                    r = this.fillColor,
                    n = this.borderColor;
                void 0 != m && (this.adjustBorderColor ? n = m : r = m);
                ...
                "H" != s ? (y = a - p / 2, d = b < i + l + 10 && "down" != s ? b + m : b - l - m) : (2 * m > l && (m = l / 2), d = b - l / 2, y = a < h + (j - h) / 2 ? a + m : a - p - m);
                d + l >= k && (d = k - l);
                d < i && (d = i);
                y < h && (y = h);
                y + p > j && (y = j - p);
                0 < t || 0 == m ? (n = AmCharts.rect(f, p, l, r, this.fillAlpha, this.borderThickness, n, this.borderAlpha, this.cornerRadius), this.showBullet && (f = AmCharts.circle(f, this.bulletSize, r, this.fillAlpha), f.translate(a, b), this.pointer = f)) : (k = [], t = [], "H" != s ? (h = a - y, h > p - m && (h = p - m), h < m && (h = m), k = [0, h - m, a - y, h + m, p, p, 0, 0], t = b < i + l + 10 && "down" != s ? [0, 0, b - d, 0, 0, l, l, 0] : [l, l, b - d, l, l, 0, 0, l]) : (i = b - d, i > l - m && (i = l - m), i < m && (i = m), t = [0, i - m, b - d, i + m, l, l, 0, 0], k = a < h + (j - h) / 2 ? [0, 0, a - y, 0, 0, p, p, 0] : [p, p, a - y, p, p, 0, 0, p]), n = AmCharts.polygon(f,
                k, t, r, this.fillAlpha, this.borderThickness, n, this.borderAlpha));
                g.push(n);
                n.toFront();
                z && z.toFront();
                e.toFront();
...
AmCharts.TrendLine = AmCharts.Class({
    ...
    draw: function () {
        ...
        n && !u && (isNaN(q) || (e = n.getCoordinate(q)), isNaN(p) || (f = n.getCoordinate(p)));
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity != this.max) {
                ...
                if (!0 == i) {
                    ...
                    2 < p && (q = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, n = Math.round(Math.log(this.minReal) * Math.LOG10E), q > this.gridCount && (r = Math.ceil(q / this.gridCount)))
                ...
                t = !1;
                for (e = n; e < q; e += r) v = AmCharts.roundTo(this.step * e + this.min, d), - 1 != String(v).indexOf("e") && (t = !0, String(v).split("e"));
                this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
                for (e = n; e < q; e += r) if (n = this.step * e + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !(this.integersOnly && Math.round(n) != n)) {
                    !0 == i && (0 == n && (n = this.minReal), 2 < p && (n = Math.pow(10, e)), t = -1 != String(n).indexOf("e") ? !0 : !1);
                    this.useScientificNotation && (t = !0);
                    this.usePrefixes && (t = !1);
                    t ? (v = -1 == String(n).indexOf("e") ? n.toExponential(15) : String(n), v = v.split("e"), d = Number(v[0]), v = Number(v[1]), d = AmCharts.roundTo(d, 14), 10 == d && (d = 1, v += 1), v = d + "e" + v, 0 == n && (v = "0"), 1 == n && (v = "1")) : (i && (d = String(n).split("."), s.precision = d[1] ? d[1].length : -1), v = this.usePrefixes ? AmCharts.addPrefix(n, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, s) : AmCharts.formatNumber(n, s, s.precision));
                    ...
                    if (n == this.baseValue && "radar" != j) {
                        ...
                        J && (d = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), d = AmCharts.line(a.container, J, E, this.gridColor, d, 1, this.dashLength), d.translate(n, v), this.grid0 = d, a.axesSet.push(d),
                        d.toBack())
                    }
                }
                e = this.baseValue;
        ...
        if (AmCharts.ifArray(a)) {
            ...
            if (this.parseDates && !this.equalSpacing) {
                ...
                m = d.count, r = AmCharts.getPeriodDuration(e, m), r < k && (e = l.period, m = l.count, r = k), a = e, "WW" == a && (a = "DD"), this.stepWidth = this.getStepWidth(this.timeDifference), h = Math.ceil(this.timeDifference / r) + 1, l = AmCharts.resetDateToMin(new Date(this.startTime - r), e, m, s).getTime(), a == e && 1 == m && (n = r * this.stepWidth), this.cellWidth = k * this.stepWidth, g = Math.round(l / r), d = -1, g / 2 == Math.round(g / 2) && (d = -2, l -= r), 0 < this.gridCount) for (g = d; g <= h; g++) {
                    ...
                    p = !1;
                    this.nextPeriod[a] && (p = this.checkPeriodChange(this.nextPeriod[a], 1, q, l));
                    var u = !1;
                    p ? (l = this.dateFormatsObject[this.nextPeriod[a]], u = !0) : l = this.dateFormatsObject[a];
                    t || (u = !1);
                    l = AmCharts.formatDate(new Date(q), l);
                    if (g == d && !i || g == h && !j) l = " ";
                    k = new this.axisItemRenderer(this, k, l, !1, n, 0, !1, u);
                    this.pushAxisItem(k);
                    l = q
                }
                ...
                if (this.parseDates && this.equalSpacing) {
                    ...
                    s = !1;
                    for (this.end - this.start > this.gridCount && (s = !0); g < n; g++) if (q = this.data[g].time, this.checkPeriodChange(e, m, q, l)) {
                ...
                for (h = 0; g <= this.end + 2; g += t) {
                    ...
                    s = this.cellWidth;
                    m && (s = NaN);
                    k = new this.axisItemRenderer(this, k, l, !0, s, n,
                    void 0, !1, n);
                    this.pushAxisItem(k)
                }
            }
...
AmCharts.RadAxis = AmCharts.Class({
    construct: function (a) {
        ...
        if (b) {
            ...
            for (var a = b.chartData, r = a.length, n = 0; n < r; n++) {
                var q = 180 - 360 / r * n,
                ...
                if (j) {
                    var t = "start",
                        p = g + (this.axisWidth + i) * Math.sin(q / 180 * Math.PI),
                        s = h + (this.axisWidth + i) * Math.cos(q / 180 * Math.PI);
                    if (180 == q || 0 == q) t = "middle", p -= 5;
                    0 > q && (t = "end", p -= 10);
                    180 == q && (s -= 5);
                    0 == q && (s += 5);
                    q = AmCharts.text(b.container, a[n].category, m, k, l, t);
                    q.translate(p + 5, s);
                    this.set.push(q);
                    q.getBBox()
                }
...
AmCharts.RadItem = AmCharts.Class({
    construct: function (a, b, d, e, f, g, h) {
        ...
        var m = a.axisColor,
            ...
            C, g = a.x,
            J = a.y;
        h ? (z = !0, isNaN(h.tickLength) || (n = h.tickLength),
        void 0 != h.lineColor && (s = h.lineColor), isNaN(h.lineAlpha) || (q = h.lineAlpha), isNaN(h.dashLength) || (t = h.dashLength), isNaN(h.lineThickness) || (p = h.lineThickness), !0 == h.inside && (y = !0)) : d || (q /= 3, n /= 2);
        var E = "end",
            W = -1;
        y && (E = "start", W = 1);
        if (z) {
            var L = AmCharts.text(l, d, k, i, j, E);
            L.translate(g + (n + 3) * W, b);
            e.push(L);
            this.label = L;
            C = AmCharts.line(l, [g, g + n * W], [b, b], m, r, p);
            e.push(C)
        }
        b = a.y - b;
        if ("polygons" == v) {
            ...
            N.push(N[0]);
            F.push(F[0]);
            d = AmCharts.line(l, N, F, s, q, p, t)
        } else d = AmCharts.circle(l, b, "#FFFFFF", 0, p, s, q);
        d.translate(g, J);
        e.push(d);
        if (1 == f && 0 < x && !h) {
            h = a.previousCoord;
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function () {
        ...
        for (K = J; K <= E; K++) {
            ...
            if (pa) {
                ...
                switch (g) {
                    case "line":
                        isNaN(P) ? n || (this.drawLineGraph(q, p, ka, la), q = [], p = [], ka = [], la = []) : (P < F && (w.isNegative = !0), q.push(B), p.push(A), V = B, Y = A, na = B, oa = A, Va && (ka.push(X),
                        la.push(U)));
                        break;
                    case "smoothedLine":
                        isNaN(P) ? n || (this.drawSmoothedGraph(q, p, ka, la), q = [], p = [], ka = [], la = []) : (P < F && (w.isNegative = !0), q.push(B), p.push(A), V = B, Y = A, na = B, oa = A, Va && (ka.push(X), la.push(U)));
                        break;
                    case "step":
                        isNaN(P) ? n || (t = NaN, this.drawLineGraph(q, p, ka, la), q = [], p = [], ka = [], la = []) : (P < F && (w.isNegative = !0), l ? (isNaN(s) || (q.push(s), p.push(A - za)), p.push(A - za), q.push(B), p.push(A + Ya), q.push(B)) : (isNaN(t) || (p.push(t), q.push(B - za)), q.push(B - za), p.push(A), q.push(B + Ya), p.push(A)), s = B, t = A, V = B, Y = A, na = B, oa = A);
                        break;
                    case "column":
                        var Aa = ea;
                        void 0 != w.lineColor && (Aa = w.lineColor);
                        if (!isNaN(P)) {
                            P < F && (w.isNegative = !0, Da && (ta = Da), void 0 != va && (ea = va));
                            var mb = f.min,
                                nb = f.max;
                            if (!(P < mb && (ia < mb || void 0 == ia) || P > nb && ia > nb)) if (l) {
                                ...
                                if (H < j && 0 < G && (ja = new AmCharts.Cuboid(e, Z, G, z, y, ta,
                                Ga, M, Aa, Q, ba, r, l), "bottom" != C)) if (C = f.reversed ? "left" : "right", 0 > P) C = f.reversed ? "right" : "left";
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(q, p, ka, la) : this.drawLineGraph(q, p, ka, la), W || this.launchAnimation()
    },
    ...
    drawLineGraph: function (a, b, d, e) {
        if (1 < a.length) {
            ...
            if (0 < f && (j = a.join(";").split(";"), k = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), j = a.concat(d), k = b.concat(e)) : this.rotate ? (k.push(k[k.length - 1]), j.push(p), k.push(k[0]), j.push(p), k.push(k[0]), j.push(j[0])) : (j.push(j[j.length - 1]), k.push(p), j.push(j[0]), k.push(p), j.push(a[0]), k.push(k[0]))), a = AmCharts.polygon(g, j, k, m, f, 0, 0, 0, this.gradientRotation), h.push(a), n || void 0 != r)) q || (q = f), n || (n = r), g = AmCharts.polygon(g, j, k, n, q, 0, 0, 0, this.gradientRotation), i.push(g);
            this.applyMask(i, h)
        }
    },
    ...
    drawSmoothedGraph: function (a, b, d, e) {
        if (1 < a.length) {
            ...
            if (0 < l && (k = a.join(";").split(";"), s = b.join(";").split(";"), j = "", 0 < d.length ? (d.reverse(), e.reverse(), k = a.concat(d), s = b.concat(e)) : (this.rotate ? (j += " L" + p + "," + b[b.length - 1], j += " L" + p + "," + b[0]) : (j += " L" + a[a.length - 1] + "," + p, j += " L" + a[0] + "," + p), j += " L" + a[0] + "," + b[0]), d = new AmCharts.Bezier(g, k, s, NaN, 0, 0, m, l, f, j), h.push(d.path), n || void 0 != r)) q || (q = l), n || (n = r), a = new AmCharts.Bezier(g, a, b, NaN, 0, 0, n, q, f, j), i.push(a.path);
            this.applyMask(i, h)
        }
    },
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    createCursor: function () {
        var a = this.chart,
            ...
            p = d.tickLength;
        h.pointerWidth = p;
        a ? (i = [0, n, n + k], j = [0, 0, l]) : (i = [k, 0, 0], j = [l, 0, q - 1]);
        this.line = b = AmCharts.line(this.container, i, j, this.cursorColor, b, 1);
        this.set.push(b);
        a ? (f && (h.pointerWidth = 0), "right" == e ? f ? h.setBounds(m, r + l, m + n + k, r + q + l) : h.setBounds(m + n + k + g, r + l, m + n + 1E3, r + q + l) : f ? h.setBounds(m, r, n + m, q + r) : h.setBounds(-1E3, - 1E3, m - p - g, r + q + 15)) : (h.maxWidth = n, d.parseDates && (p = 0, h.pointerWidth = 0), "top" == e ? f ? h.setBounds(m + k, r + l, n + k + m, q + r) : h.setBounds(m + k, - 1E3, n + k + m, r + l - p - g) : f ? h.setBounds(m, r, n + m, q + r - p) : h.setBounds(m, r + q + p + g - 1, m + n, r + q + p + g));
        this.hideCursor()
    },
    ...
    updateCursor: function (a, b) {
        ...
        if (this.enabled) {
            ...
            if (d.mouseIsOver || v || C || this.forceShow) if (this.forceShow = !1, C) {
                ...
                "start" == z && (n -= g.cellWidth / 2);
                "mouse" == z && d.mouseIsOver && (n = q ? f - 2 : e - 2);
                if (q) {
                    if (0 > n) if (v) n = 0;
                    else {
                        this.hideCursor();
                ...
                if (J && this.valueBalloonsEnabled && u && d.balloon.enabled) {
                    ...
                    x = t.y, !isNaN(x))) {
                        ...
                        if (q) {
                            if (i = x, 0 > n || n > m) p = !1
                        } else if (i = n, n = x, 0 > i || i > l + h) p = !1;
                        p && (p = s.valueBalloon, y = d.getBalloonColor(s, t), p.setBounds(j, k, j + l, k + m), p.pointerOrientation = "H", p.changeColor(y), void 0 != s.balloonAlpha && (p.fillAlpha = s.balloonAlpha), void 0 != s.balloonTextColor && (p.color = s.balloonTextColor), p.setPosition(i + j, n + k), s = d.formatString(s.balloonText, t, s), "" != s && p.showBalloon(s), !q && p.set && p.set.hide(), g.push({
                            yy: x,
                            balloon: p
                        }))
                    }
    ...
    draw: function () {
        ...
        if (k = a.graph) {
            ...
            for (var g = Infinity, h = -Infinity, n = 0; n < d.length; n++) {
                var q = d[n].axes[r.id].graphs[k.id].values,
                    p;
...
AmCharts.wedge = function (a, b, d, e, f, g, h, i, j, k, l) {
    var m = Math.round,
        ...
        i = m(i),
        r = m(h / g * i),
        n = AmCharts.VML; - 359.95 >= f && (f = -359.95);
    var q = 1 / 180 * Math.PI,
        p = b + Math.cos(e * q) * i,
        s = d + Math.sin(-e * q) * r,
        t = b + Math.cos(e * q) * g,
        u = d + Math.sin(-e * q) * h,
        x = b + Math.cos((e + f) * q) * g,
        z = d + Math.sin((-e - f) * q) * h,
        y = b + Math.cos((e + f) * q) * i,
        q = d + Math.sin((-e - f) * q) * r,
        v = {
    ...
    var e = a.set(),
        J;
    n && (p = m(10 * p), t = m(10 * t), x = m(10 * x), y = m(10 * y), s = m(10 * s), u = m(10 * u), z = m(10 * z), q = m(10 * q), b = m(10 * b), j = m(10 * j), d = m(10 * d), g *= 10, h *= 10, i *= 10, r *= 10, 1 > Math.abs(f) && (1 >= Math.abs(x - t) && 1 >= Math.abs(z - u)) && (J = !0));
    f = "";
    if (0 < j) {
        n ? (path = " M" + p + "," + (s + j) + " L" + t + "," + (u + j), J || (path += " A" + (b - g) + "," + (j + d - h) + "," + (b + g) + "," + (j + d + h) + "," + t + "," + (u + j) + "," + x + "," + (z + j)), path += " L" + y + "," + (q + j), 0 < i && (J || (path += " B" + (b - i) + "," + (j + d - r) + "," + (b + i) + "," + (j + d + r) + "," + y + "," + (j + q) + "," + p + "," + (j + s)))) : (path = " M" + p + "," + (s + j) + " L" + t + "," + (u + j), path += " A" + g + "," + h + ",0," + C + ",1," + x + "," + (z + j) + " L" + y + "," + (q + j), 0 < i && (path += " A" + i + "," + r + ",0," + C + ",0," + p + "," + (s + j)));
        path += " Z";
        c = a.path(path, void 0, void 0, "1000,1000").attr(v);
        e.push(c);
        var E = a.path(" M" + p + "," + s + " L" + p + "," + (s + j) + " L" + t + "," + (u + j) + " L" + t + "," + u + " L" + p + "," + s + " Z", void 0, void 0, "1000,1000").attr(v),
            j = a.path(" M" + x + "," + z + " L" + x + "," + (z + j) + " L" + y + "," + (q + j) + " L" + y + "," + q + " L" + x + "," + z + " Z", void 0, void 0, "1000,1000").attr(v);
        e.push(E);
        e.push(j)
    }
    n ? (J || (f = " A" + m(b - g) + "," + m(d - h) + "," + m(b + g) + "," + m(d + h) + "," + m(t) + "," + m(u) + "," + m(x) + "," + m(z)), g = " M" + m(p) + "," + m(s) + " L" + m(t) + "," + m(u) + f + " L" + m(y) + "," + m(q)) : g = " M" + p + "," + s + " L" + t + "," + u + (" A" + g + "," + h + ",0," + C + ",1," + x + "," + z) + " L" + y + "," + q;
    0 < i && (n ? J || (g += " B" + (b - i) + "," + (d - r) + "," + (b + i) + "," + (d + r) + "," + y + "," + q + "," + p + "," + s) : g += " A" + i + "," + r + ",0," + C + ",0," + p + "," + s);
...
AmCharts.AmPieChart = AmCharts.Class({
    ...
    construct: function () { 
        ...
        this.colors = "#98B72E #CE201E #E18F19 #507282 #E3BF0B #0f83be #703f8e #999999 #333333 #ba136b #ab7455 #6e9e76 #605399 #2e5dd1 #456b4d #507282 #CE201E #E18F19 #98B72E #E3BF0B #0f83be #703f8e #999999 #333333 #ba136b #ab7455 #6e9e76 #605399 #2e5dd1 #456b4d".split(" ");
        this.pieAlpha = 1;
        this.pieBaseColor;
    ...
    drawChart: function () {
        ...
        if (AmCharts.ifArray(b)) {
            if (0 < a.realWidth && 0 < a.realHeight) {
                ...
                a.chartDataLabels = [];
                a.ticks = [];
                var m, r, n, q = AmCharts.toNumber(a.labelRadius),
                    p = a.measureMaxLabel();
                ...
                n || (f = 0 <= q ? f - i - j - 2 * p : f - i - j, g = g - k - l, n = Math.min(f, g), g < f && (n /= 1 - a.angle / 90, n > f && (n = f)), a.pullOutRadiusReal = AmCharts.toCoordinate(a.pullOutRadius, n), n = 0 <= q ? n - 1.8 * (q + a.pullOutRadiusReal) : n - 1.8 * a.pullOutRadiusReal, n /= 2);
                ...
                for (l = 0; l < b.length; l++) if (f = b[l], !0 != f.hidden && 0 < f.percents) {
                    var s = 360 * -f.percents / 100,
                        ...
                        p = Math.sin((-g - s / 2) / 180 * Math.PI) * (k / n),
                        i = {
                            fill: f.color,
                    ...
                    i = AmCharts.wedge(e, m, r, g, s, n, k, h, a.depth3D,
                    i, a.gradientRatio);
                    ...
                    if (a.labelsEnabled && a.labelText && f.percents >= a.hideLabelsPercent) {
                        ...
                        if (0 <= q) {
                            var x;
                            90 >= s && 0 <= s ? (x = 0, u = "start", p = 8) : 360 >= s && 270 < s ? (x = 1, u = "start", p = 8) : 270 >= s && 180 < s ? (x = 2, u = "end", p = -8) : 180 >= s && 90 < s && (x = 3, u = "end", p = -8);
                            f.labelQuarter = x
                        } else u = "middle";
                        s = a.formatString(a.labelText,
                        f);
                        s = AmCharts.text(e, s, a.color, a.fontFamily, a.fontSize, u);
                        s.translate(j + 1.5 * p, t);
                        f.tx = j + 1.5 * p;
                        f.ty = t;
