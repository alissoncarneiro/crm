...
<div id="conteudo_detalhes">
   <table width="100%" border="0" cellspacing="2" cellpadding="0">
       <tr>
         <td width="1%"></td>
         <td colspan="3"><br>
         	<div align="left"><img src="images/seta.gif" width="4" height="7" /><span class="tit_detalhes">Bloqueios de Mestre x Detalhe</span></div>
   	     <br></td>
       </tr>
	<tr>
		<td colspan="4">
	...
	<tr>
	  <td>&nbsp;</td>
        ...
        ?>
        <input type="button" onclick="javascript:bloqueios_mestre_det_custom_p1();" value="Exibir" class="botao_form" />
        </td>
	  </tr>
    </table>
