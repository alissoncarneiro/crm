<?php
/*
 * class.PoliticaComercialDescItem.php
 * Autor: Alex
 * 18/11/2010 16:15
 * -
 *
...
class PoliticaComercialDescItem{
    private $ArDadosItem;
    ...
    public function ValidaItem(){
        ...
        $SqlPoliticaItem = "SELECT ".((TipoBancoDados == 'mssql')?'TOP(1)':'')." pct_max_desc FROM is_param_politica_comercial_desc_item WHERE sn_ativo = 1 AND ('".date("Y-m-d")."' BETWEEN dthr_validade_ini AND dthr_validade_fim)";
